...
public class Code1IdLib: UIView {
    ...
    public func start(father: UIViewController) {
        ...
        // 번들아이디 체크
        let bundle = Bundle(for: Code1IdLib.self).bundleIdentifier
...
//        print(AES128Util.encrypt(string: bundle!))
        ...
        let storyboard = UIStoryboard(name: "Live", bundle: Bundle(for: Code1IdLib.self))
